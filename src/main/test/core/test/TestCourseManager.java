...
public class TestCourseManager {
	...
	@Test
	public void testCreateClassNameYearUniqe() {
		Mockito.doCallRealMethod().doNothing().when(this.admin).createClass(Mockito.anyString(), AdditionalMatchers.lt(2017), Mockito.anyString(), Mockito.anyInt());
